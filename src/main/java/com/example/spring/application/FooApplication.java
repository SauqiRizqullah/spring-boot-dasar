...
import com.example.spring.listener.AppStartingListener;
...
//    }
    ...
    public static void main(String[] args) {
        ...
        application.setBannerMode(Banner.Mode.OFF); // salah satu method untuk mengubah setting aplikasi spring boot
